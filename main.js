function startClassification ()
{
    ...
    classifier = ml5. soundClassifier ('https://teachablemachine.withgoogle.com/models/wr0PwusDO/model.json', modelReady);
} 
...
function gotResults (error , results) 
{
    ...
    else 
    {
       ...
       +random_color_r+" , "+random_number_b+" , "+random_number_g+")"
